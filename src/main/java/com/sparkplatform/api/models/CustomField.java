...
@JsonDeserialize(using=CustomField.MapperDeserializer.class)
public class CustomField extends Base {
	
	private static final long serialVersionUID = 17L;

	@JsonIgnore
	private Map<String, Field> fieldMap = new HashMap<String, CustomField.Field>();
	 ...
	 * class instance.
	 */
	public static class MapperDeserializer extends JsonDeserializer<CustomField> {
		@SuppressWarnings("deprecation")
		@Override
		public CustomField deserialize(JsonParser jp,
	...
	public static class Field extends Base {
		...
		public String toString() {
			return "Field [label=" + label + ", searchable=" + searchable
					...
					+ ", hasList=" + hasList + ", maxListSize=" + maxListSize 
					+ ", mlsVisible=" + mlsVisible
					+ "]";
		}
		...
		public int getMaxListSizeAsInt() {
			try {
				return Integer.valueOf( maxListSize );
			} catch (Exception e) {}
			return 0;
		}
	...
	public CustomField(Map<String, Field> fieldMap) {
		super();
	...
	public CustomField.Field getField(String key){
